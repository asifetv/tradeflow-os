"""Add multi-tenancy support - companies, users, and company_id to all entities
...
def upgrade() -> None:
    ...
    op.create_index('ix_users_email_company', 'users', ['email', 'company_id'], unique=True)
    ...
    with op.batch_alter_table('deal', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_deal_company_id', 'companies', ['company_id'], ['id'])
    ...
    with op.batch_alter_table('customer', schema=None) as batch_op:
        batch_op.add_column(sa.Column('company_id', sa.String(36), nullable=True))
        batch_op.create_foreign_key('fk_customer_company_id', 'companies', ['company_id'], ['id'])
    ...
    with op.batch_alter_table('quote', schema=None) as batch_op:
        batch_op.add_column(sa.Column('company_id', sa.String(36), nullable=True))
        batch_op.create_foreign_key('fk_quote_company_id', 'companies', ['company_id'], ['id'])
    ...
    with op.batch_alter_table('customer_po', schema=None) as batch_op:
        batch_op.add_column(sa.Column('company_id', sa.String(36), nullable=True))
        batch_op.create_foreign_key('fk_customer_po_company_id', 'companies', ['company_id'], ['id'])
    ...
    with op.batch_alter_table('activity_log', schema=None) as batch_op:
        batch_op.add_column(sa.Column('company_id', sa.String(36), nullable=True))
        batch_op.create_foreign_key('fk_activity_log_company_id', 'companies', ['company_id'], ['id'])
