  ...
  async function onSubmit(data: CustomerFormValues) {
    try {
      if (initialCustomer) {
        ...
        // For new customers, exclude customer_code as it's auto-generated by backend
        const { customer_code, ...createData } = data
        const newCustomer = await createMutation.mutateAsync(createData as any)
